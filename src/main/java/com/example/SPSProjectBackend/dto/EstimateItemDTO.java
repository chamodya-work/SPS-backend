...
public class EstimateItemDTO {
    ...
    public String getLinedes() { return linedes; }
    public void setLinedes(String linedes) { this.linedes = linedes; }

    public Float getLength() { return length; }
    public void setLength(Float length) { this.length = length; }

    public Double getEstCost() { return estCost; }
    public void setEstCost(Double estCost) { this.estCost = estCost; }
