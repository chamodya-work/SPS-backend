...
//            return ResponseEntity.ok("Status updated successfully to 10 for estimate: " + estimateNo + " and department: " + deptId);
//        } catch (Exception e) {
...
//            return ResponseEntity.ok("Status updated successfully to 11 for estimate: " + estimateNo + " and department: " + deptId);
//        } catch (Exception e) {
//            return ResponseEntity.badRequest().body("Error updating status: " + e.getMessage());
//        }
//    }
...
//    }
    ...
    public ResponseEntity<String> updateStatusTo13(
        ...
        try {
            ...
            return ResponseEntity.ok("Status updated successfully to 13 for estimate: " + estimateNo + " and department: " + deptId);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body("Error updating status: " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<String> updateStatusTo14(
        ...
        try {
            ...
            return ResponseEntity.ok("Status updated successfully to 14 for estimate: " + estimateNo + " and department: " + deptId);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body("Error updating status: " + e.getMessage());
        }
    }
