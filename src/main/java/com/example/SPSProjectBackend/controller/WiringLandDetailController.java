...
public class WiringLandDetailController {
    ...
    public ResponseEntity<ServiceDetailsDTO> getServiceDetailsByEstimate(
        ...
        // Step 1: Dynamically get deptId from Pcesthmt based on estimateNo (latest revision)
        ...
        // Step 2: Find WiringLandDetail by deptId (assume one per deptId; if multiple, take first)
