    ...
    public Pegschdmt save(Pegschdmt data) {
        ...
        for (SpPeggingDmt template : materialTemplates) {
            try {
                ...
                BigDecimal quantityPerUnit = template.getEstimateQty() != null ? template.getEstimateQty() : BigDecimal.ZERO;
                ...
                BigDecimal price = template.getUnitPrice() != null ? BigDecimal.valueOf(template.getUnitPrice()) : BigDecimal.ZERO;
